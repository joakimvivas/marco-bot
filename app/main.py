...
from app.routers import chatbot  # Import chatbot without circular dependencies
...
app.include_router(chatbot.router)  # Ensure this router is correctly defined in chatbot.py
